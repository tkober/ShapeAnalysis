...
...
\begin{description}
	\item ... \analysispageref{Sort_Fixed}{5}
	\item ... \analysispageref{Sort_Fixed}{6}
	\item ... \analysispageref{Sort_Fixed}{7}
	\item ... \analysispageref{Sort_Fixed}{8}
	\item ... \analysispageref{Sort_Fixed}{9}
	\item ... \analysispageref{Sort_Fixed}{10}
	\item ... \analysispageref{Sort_Fixed}{11}
	\item ... \analysispageref{Sort_Fixed}{12}
\end{description}
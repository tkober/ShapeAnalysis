...
\begin{itemize}[$\rightarrow$]
	\item Es sind nur gute Linsen im Topf gewesen, mindestens eine.\analysispageref{C}{14}
	\item Es waren mindestens eine gute und genau eine schlechte Linse im Topf.\analysispageref{C}{15}
	\item Es waren mindestens eine schlechte und genau eine gute Linse im Topf.\analysispageref{C}{16}
	...
	\item Es waren sowohl mindestens eine gute als auch mindestens eine schlechte Linse im Topf.\analysispageref{C}{19}
	\item Es sind nur schlechte Linsen im Topf gewesen, mindestens eine.\analysispageref{C}{20}
